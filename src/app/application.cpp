...
int main(int argc, char** argv) {
  ...
  lcd::lcd_controller_ptr controller =
      std::move(std::make_shared<lcd::lcd_controller>());
  window.on_contrast_slider([=](float value) {
    controller->m_port.m_pins[static_cast<int>(lcd::lcd_controller::pinout::v0)]
        .set_voltage(value * 5.0);
  });
  window.on_brightness_slider([=](float value) {
    controller->m_port
        .m_pins[static_cast<int>(lcd::lcd_controller::pinout::anode)]
        .set_voltage(value * 5.0);
    controller->m_port
        .m_pins[static_cast<int>(lcd::lcd_controller::pinout::catode)]
        .set_voltage(0.0f);
  });
  ...
  auto instruction = [](lcd::lcd_controller& controller, bool rs, bool rw,
                        uint8_t byte) {
    controller.m_port.m_pins[static_cast<int>(lcd::lcd_controller::pinout::rw)]
        .set_voltage(rw ? 5.0f : 0.0f);
    controller.m_port.m_pins[static_cast<int>(lcd::lcd_controller::pinout::rs)]
        .set_voltage(rs ? 5.0f : 0.0f);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data0)],
        byte & 1);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data1)],
        byte & 2);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data2)],
        byte & 4);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data3)],
        byte & 8);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data4)],
        byte & 16);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data5)],
        byte & 32);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data6)],
        byte & 64);
    lcd::digital_operation::write(
        controller.m_port
            .m_pins[static_cast<int>(lcd::lcd_controller::pinout::data7)],
        byte & 128);
    controller.m_port.m_pins[static_cast<int>(lcd::lcd_controller::pinout::en)]
        .set_voltage(5.0f);
    controller.m_port.m_pins[static_cast<int>(lcd::lcd_controller::pinout::en)]
        .set_voltage(0.0f);
  };
  ...
  std::thread([=]() {
    ...
    std::this_thread::sleep_for(
        std::chrono::seconds(1));  // set 1 line mode and show a second
    instruction(*controller, 0, 0, 0b00111000);
    std::this_thread::sleep_for(
        std::chrono::milliseconds(4));  // switch back to 2 line mode
    instruction(*controller, 1, 0, 0b00000001);
    std::this_thread::sleep_for(
        std::chrono::seconds(1));  // show the 0x01 character element
    instruction(*controller, 0, 0, 0b00111000);
    std::this_thread::sleep_for(std::chrono::milliseconds(4));
    instruction(*controller, 0, 0,
                0b01001000);  // set cgram 0x08 (0x01 character)
    std::this_thread::sleep_for(std::chrono::milliseconds(4));
